...
<main role="main">
  ...
  <hr class="featurette-divider">
    ...
    <p class="text-center intro-message">
        A Purposeful Journey is a brainchild of group of friends, who came up with thought of saving a small amount every month and give it back to society on need basis during summer 2015. <a href="journey">Read more</a>.
    </p>
  ...
  <div class="row">
      ...
      <div class="jumbotron jumbotron-fluid text-border-big">
        <div class="container text-center">
          <h1 class="">SMALL STEPS! GREAT JOURNEY TOGETHER!</h1>
          <p class="lead">To make your journey purposeful <a href="contact">contact us</a> now.</p>
        </div>
      </div>
      </div>
    </div>
  ...
  <div class="row featurette text-center">
      <div class="col-md-6">
        <div class="card mb-1 news-card h-300">
          ...
          <div class="card-body ">
            ...
            <marquee height="100%" width="100%" behavior="scroll" direction="up" scrollamount="5" onmouseover="this.stop();" onmouseout="this.start();">
              <ul class="list-unstyled">
                <li class="mb-4"> <i class="fas fa-angle-double-right mr-2"></i> <span id="mon_yr"></span> contribution to Sellur, Madurai old age home has been sent. </li>
  ...
  <p class="display-4 text-center mb-3">Initiatives</p>
    ...
    <div class="row mt-4">
      <div class="col-lg-3">
        <div class="card mb-1">
          <div class="card-header">
          <i class="fas fa-chalkboard-teacher"></i> Techies2Teach
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-3 mb-1">
        <div class="card">
          <div class="card-header">
          <i class="fas fa-plane-departure"></i> Trip2Educate
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-3 mb-1">
        <div class="card">
          <div class="card-header">
          <i class="fas fa-hand-holding-usd"></i> Save2Help
          </div>
          <div class="card-body">
