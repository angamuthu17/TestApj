  ...
  <div class="row">
    <div class="col-md">
      <ul class="list-unstyled">
          ...
          <li class="mt-4" style="text-align: justify;">
            <i class="fas fa-mug-hot fa-lg mr-3 text-dark w--25" aria-hidden="true"></i> <span class="font-weight-bold">Milk 2 Home</span>: This initiative to provide morning and evening milk to senior care center and children care center from our regular fund. This will not only bring energy to needy people but also smile on their face.
          </li>
          <li class="mt-4" style="text-align: justify;">
            <i class="far fa-handshake fa-lg mr-3 text-dark w--25" aria-hidden="true"></i> <span class="font-weight-bold">Hands 2 Help</span>: This is the initiate which covers all other social responsibilities including help during natural calamities, medical assistance program, environmental activities and uplifting life etc.
          </li>
          <li class="mt-4" style="text-align: justify;">
